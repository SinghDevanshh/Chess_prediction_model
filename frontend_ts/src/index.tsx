...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="gold" className="bi bi-envelope-at-fill" viewBox="0 0 16 16">
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="lightgreen" className="bi bi-file-person-fill" viewBox="0 0 16 16">
      ...
      <div className={`background-container`}>
        ...
        <div className="content-container">
          ...
          <Dock direction="middle">
            ...
            <DockIcon href='https://www.linkedin.com/in/devansh--singh/'>
              <Icons.LinkedInIcon className="size-6" />
            </DockIcon>
            <DockIcon href='https://singhdevanshh.github.io/'>
              <Icons.WebsiteIcon className="size-6" />
            </DockIcon>
            <DockIcon href="mailto: singhd80@mcmaster.ca">
              <Icons.EmailIcon className="size-6" />
            </DockIcon>
          </Dock>
        </div>
        </div>
